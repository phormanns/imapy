...
<%
    ...
    pageContext.setAttribute("deletedSubject", deletedSubject);
%>
...
%>
    <p>„<c:out value="${deletedSubject}"/>" wurde in den Papierkorb verschoben.</p>
<%
    } else {
%>
    <p>Die Nachricht wurde aus „<c:out value="${deletedFolder}"/>" entfernt.</p>
<%
    }
%>
